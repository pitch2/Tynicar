...
# Affichage des noms, prix HT, et prix TTC des accessoires du panier
print("Noms, prix HT, et prix TTC des accessoires du panier :")
for i in range(taille_panier):
    print(f"{noms_accessoires[i]} - Prix HT : {prixHT_accessoires[i]} € - Prix TTC : {prixTTC_accessoires[i]} €")
